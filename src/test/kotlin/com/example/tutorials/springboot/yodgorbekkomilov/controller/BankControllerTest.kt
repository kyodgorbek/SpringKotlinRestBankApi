package com.example.tutorials.springboot.yodgorbekkomilov.controller
...
internal class BankControllerTest @Autowired constructor(
    ...
    @Test
        fun `should return  BAD REQUST if bank with given  account number already exists`(){
           // given
